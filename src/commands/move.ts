    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives((curActive) =>
                curActive.translate(0, charDelta)
            );
            return;
        }
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                (curActive) =>
                    new vscode.Position(
                        curActive.line,
                        Math.max(curActive.character - charDelta, 0)
                    )
            );
            return;
        }
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            ...
            this.emacsController.moveRectActives(
                (curActive) =>
                    new vscode.Position(
                        Math.min(curActive.line + lineDelta, maxLine),
                        curActive.character
                    )
            );
            return;
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                (curActive) =>
                    new vscode.Position(
                        Math.max(curActive.line - lineDelta, 0),
                        curActive.character
                    )
            );
            return;
...
export class MoveBeginningOfLine extends EmacsCommand {
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                (curActive) =>
                    textEditor.document.lineAt(curActive.line).range.start
            );
        }
...
export class MoveEndOfLine extends EmacsCommand {
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                (curActive) =>
                    textEditor.document.lineAt(curActive.line).range.end
            );
            return;
        }
...
export class EndOfBuffer extends EmacsCommand {
    ...
    public async execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            const end = textEditor.document.lineAt(
...
export class ForwardParagraph extends EmacsCommand {
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                repeatedTravelForwardParagraph
            );
            return;
        }
...
export class BackwardParagraph extends EmacsCommand {
    ...
    public execute(
        ...
        if (this.emacsController.inRectMarkMode) {
            this.emacsController.moveRectActives(
                repeatedTravelBackwardParagraph
            );
            return;
        }
