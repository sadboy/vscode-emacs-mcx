...
export class DeleteBlankLines extends EmacsCommand {
    ...
    public async execute(
        ...
        for (let iSel = 0; iSel < textEditor.selections.length; ++iSel) {
            ...
            const subsequentText = curLine.text.substr(
            ...
            while (
                ...
                document.lineAt(curLineNum - previousLineOffset - 1)
                    .isEmptyOrWhitespace
            ) {
                previousLineOffset++;
            }
            ...
            await textEditor.edit((editBuilder) => {
                if (followingLineOffset > 0) {
                    ...
                    const finalFollowingEmptyLineNum =
                        curLineNum + followingLineOffset;
                ...
                if (previousLineOffset > 0) {
                    ...
                    const firstPreviousEmptyLineNum =
                        curLineNum - previousLineOffset;
