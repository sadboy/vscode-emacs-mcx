    ...
    const testcases: TestCase[] = [
        ...
        },
        {
            ...
            expected: [
                ...
                new vscode.Selection(1, 0, 1, 9),
                new vscode.Selection(2, 0, 2, 9),
            ],
        },
        {
            ...
            expected: [
                new vscode.Selection(0, 9, 0, 0),
                new vscode.Selection(1, 9, 1, 0),
    ...
    testcases.forEach(({ title, markSelection, expected }) => {
        test(title, () => {
            assert.deepStrictEqual(
                convertSelectionToRectSelections(document, markSelection),
                expected
            );
        });
    });
